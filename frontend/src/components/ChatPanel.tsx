...
export default function ChatPanel({
  ...
  return (
    <aside className="chat-panel-glass panel-enter hidden w-full flex-col lg:flex lg:w-[390px]">
      {/* Keep this header h-20 to align with main workspace headers. */}
      <div className="chat-panel-header glass-soft relative flex h-20 items-center justify-between border-b border-gray-200/80 px-6">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <div className="chat-panel-body flex-1 overflow-y-auto bg-gradient-to-b from-[#f8f9fc] to-[#f3f5fa] px-5 py-5 lg:px-6">
